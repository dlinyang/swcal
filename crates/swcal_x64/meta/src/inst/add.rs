...
pub fn add() -> Vec<InstFormat> {
    vec![
        ...
        // ADD AL, imm8 - 04 ib
        instf!("add", Legacy, opcode!(0x04), no_modrm(), reg(Gpr, u(8), RW), imm_u(8)),
        // ADD AX, imm16 - 05 iw
        instf!("add", Legacy, opcode!(0x05), no_modrm(), reg(Gpr, u(16), RW), imm_u(16)),
        // ADD EAX, imm32 - 05 id
        instf!("add", Legacy, opcode!(0x05), no_modrm(), reg(Gpr, u(32), RW), imm_u(32)),
        // ADD RAX, imm32 - 05 id (sign-extended to 64-bit)
        instf!("add", Legacy, opcode!(0x05), no_modrm(), reg(Gpr, i(64), RW), imm_i(32)),
